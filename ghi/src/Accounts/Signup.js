  ...
  useEffect(() => {
    if (signUpError) {
      Swal.fire({
        ...
        text:
          "An error occurred while creating your account. Either that email is already associated with an account " +
          "or you did not enter both an email and a password.",
      }).then(() => {
